...
state2.transitions["18"] = state12
state2.transitions["0"] = state2
state13.transitions["t"] = state14
state9.transitions["14"] = state12
state0.transitions["\n"] = state3
...
state0.transitions["\r"] = state3
state0.transitions["*"] = state9
state0.transitions["l"] = state11
state0.transitions["a"] = state6
state3.transitions["\r"] = state3
state3.transitions["	"] = state3
state3.transitions["19"] = state12
state3.transitions["\n"] = state3
state3.transitions[" "] = state3
state11.transitions["e"] = state13
state4.transitions["11"] = state12
state5.transitions["16"] = state12
...
state7.transitions["13"] = state12
state8.transitions["12"] = state12
state10.transitions["15"] = state12

return &dfa{ 
startState: state0,
states: []*state{ state0, state2, state3, state4, state5, state6, state7, state8, state9, state10, state11, state12, state13, state14, }, 
}
}
