...
state11.transitions["13"] = state12
...
state7.transitions["e"] = state13
state8.transitions["11"] = state12
state9.transitions["14"] = state12
state14.transitions["10"] = state12
state1.transitions["12"] = state12
state6.transitions[""] = state6
state6.transitions["	"] = state6
state6.transitions[" "] = state6
state6.transitions["19"] = state12
state6.transitions["\n"] = state6
...
state4.transitions["18"] = state12
state5.transitions["16"] = state12

return &dfa{ 
startState: state0,
states: []*state{ state0, state1, state2, state4, state5, state6, state7, state8, state9, state10, state11, state12, state13, state14, }, 
}
}
